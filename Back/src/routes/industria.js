...
import { getChallengeTableNames } from "../db/oracleObjectNames.js"
...
async function loadBrandChallengeSummary(marca) {
  try {
    const { challengeTable, challengeGoalsTable, challengeProgressTable } = await getChallengeTableNames()
